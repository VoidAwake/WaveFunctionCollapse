...
void APlayerCharacter::SetHUDVisible_Implementation(bool bIsVisible)
{
	...
	if (!PlayerHUD) {
		UE_LOG(LogTemp, Warning, TEXT("Failed to get PlayerHUD"))
		return;
	}

	PlayerHUD->SetHUDVisible(bIsVisible);
}
